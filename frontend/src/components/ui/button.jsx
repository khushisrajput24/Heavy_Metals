export const Button = ({
  ...
  const variants = {
    primary:
      "btn-primary cursor-pointer hover:scale-105 transition-all duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed",
    secondary:
      "btn-secondary cursor-pointer hover:scale-105 transition-all duration-200 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed",
    "secondary-blue":
